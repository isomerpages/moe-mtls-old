...
<h4 style="font-family:KaiTi;">语特相关链接
  ...
  <div class="atab">
    ...
    <label for="tab-11" style="font-family:KaiTi;font-size:22px" class="lbCh">高中语特简介：</label>
     <div class="tab-content">
     <li style="margin:5%;"><a href="https://www.moe.gov.sg/programmes/clep-jc" target="_blank">高中语特简介</a></li>
     </div></div>
 <div class="atab">
      <input id="tab-12" type="checkbox" name="tab">
    <label for="tab-12" style="font-family:KaiTi;font-size:22px" class="lbCh">高中语特网站：</label>
     <div class="tab-content">
     <li style="margin:5%;"><a href="https://go.gov.sg/preuclep" target="_blank">高中语特网站</a></li>
</div></div>
<div class="atab">
      <input id="tab-13" type="checkbox" name="tab">
    <label for="tab-13" style="font-family:KaiTi;font-size:22px" class="lbCh">教育部语特奖学金：</label>
     <div class="tab-content">
     <li style="margin:5%;"><a href="https://www.moe.gov.sg/financial-matters/awards-scholarships/programme-scholarships-pre-u " target="_blank">教育部语特奖学金 </a></li>
     </div></div>
<br/>
