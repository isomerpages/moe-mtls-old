...
<p style="font-size:25px;font-family:KaiTi">新加坡学生学习平台（Singapore Student Learning Space)为学生提供了丰富的学习资源。学生可以登录SLS，搜索各高中华文科目的学习资源。这些资源能让学生进行延伸学习或巩固所学，同时也能培养他们自主学习的能力。
  ...
  <div class="atab">
    ...
    <label for="tab-7" style="font-family:KaiTi;font-size:22px" class="lbCh">H1华文数码资源示例:
     ...
     <div class="tab-content">
     <iframe class="iframe1" width="560" height="315" src="https://www.youtube.com/embed/YngQbtjEUps" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br/>
    </div></div>
  <div class="atab">
    ...
    <label for="tab-8" style="font-family:KaiTi;font-size:22px" class="lbCh">华文B数码资源示例:
     ...
     <div class="tab-content">
     <iframe class="iframe1" width="560" height="315" src="https://www.youtube.com/embed/wLFDKHW4ogc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br/>
    </div></div>
  <div class="atab">
    ...
    <label for="tab-9" style="font-family:KaiTi;font-size:22px" class="lbCh">H2华文与文学数码资源示例：
     ...
     <div class="tab-content">
     <div class="row">
  <div class="column" style="float: left; width: 50%;padding: 5px;"><br/>
...
<h4 style="font-family:KaiTi;">语特相关链接
  ...
  <div class="atab">
    ...
    <label for="tab-13" style="font-family:KaiTi;font-size:22px" class="lbCh">教育部语特奖学金：</label>
     <div class="tab-content">
     <p><li style="margin:5%;"><a href="https://www.moe.gov.sg/financial-matters/awards-scholarships/programme-scholarships-pre-u " target="_blank">教育部语特奖学金 </a></li>
     </div></div>
