...
<img src="/images/CL-PreU-Header.jpg"><br/>
  <a href="#C1" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">高中华文课程总览</a>
 <a href="#C2" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">H1华文与华文B</a>
 <a href="#C3" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">H2华文与文学</a>
 <a href="#C4" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">H2中国通识</a>
 <a href="#C5" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">H2翻译</a>
 <a href="#C6" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">高中华文课程数码资源</a>
 <a href="#C7" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">高中华文语文特选课程</a>
 <a href="#C8" style="background-color: #d14165; font-size: 24px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 22px 24px; color: #ffffff; border-radius: 35px; display: inline-block; miso-padding-alt: 0;">双文化课程</a><br/>
