...
<img src="/images/CL-PreU-Header.jpg"><br/>
 ...
 <a href="#C5" style="background-color: #d14165; font-size: 22px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 20px 22px; color: #ffffff; border-radius: 32px; display: inline-block; miso-padding-alt: 0;">H2翻译</a>
 <a href="#C6" style="background-color: #d14165; font-size: 22px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 20px 22px; color: #ffffff; border-radius: 32px; display: inline-block; miso-padding-alt: 0;">高中华文课程数码资源</a>
 <a href="#C7" style="background-color: #d14165; font-size: 22px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 20px 22px; color: #ffffff; border-radius: 32px; display: inline-block; miso-padding-alt: 0;">高中华文语文特选课程</a>
 <a href="#C8" style="background-color: #d14165; font-size: 22px; font-family:KaiTi; font-weight: bold; text-decoration: none; padding: 20px 22px; color: #ffffff; border-radius: 32px; display: inline-block; miso-padding-alt: 0;">双文化课程</a><br/>
