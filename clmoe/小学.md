...
<div class="atab">
    ...
    <label for="tab-3" style="font-family:KaiTi;font-size:22px;" class="lbCh">3. 遵循学习规律，符合认知发展 
     ...
     <div class="tab-content">
       <ul>
         <li style="font-family:KaiTi;font-size:22px;">选取适合学生年龄和认知发展的语料和方式。<strong>（*嵌进“各课程的学习重点”图表）</strong></li></ul>
...
<div class="atab">
    ...
    <label for="tab-5" style="font-family:KaiTi;font-size:22px" class="lbCh">5. 培养情意品德，传承华族文化  
     ...
     <div class="tab-content">
        <ul>
         <li style="font-family:KaiTi;font-size:22px"></li>
            <li style="font-family:KaiTi;font-size:22px"></li>
       </ul>
</div></div>
...
<div class="atab">
 ...
 <h5 id="C2"><span style="color:#d14165;font-size:35px;font-family:KaiTi">教学资源</span> </h5> 
