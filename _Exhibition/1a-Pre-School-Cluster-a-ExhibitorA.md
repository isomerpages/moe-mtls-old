...
<table border="0">
  <tr>
    <td>
      <iframe width="380" height="315" src="https://v2.isomer.gov.sg/configuration/pages/overview/" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen name="iframe1" style="border:none;"></iframe>
    </td>
   </tr>
  <tr>
   <td>
